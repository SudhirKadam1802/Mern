...
// H.w ->check what happens if value passed in slice() are negative
...
/* write a function which prints the prefix sum of an array 
 ...
 input :  [1,2,3,4,5], ind1=1, inde2=4
...
input 1 : arr =[1,2,3,4,5]  --> odd length array
output1 : 2 4

input 2 : arr =[1,2,3,4,5,6]  --> Even length array
output2 : 2 4 6
*/
arr =[1,2,3,4,5,6];
...
*/
 ...
 /* H.W - Given an array of consecutive numbers, but there's on number that's missing,find it
